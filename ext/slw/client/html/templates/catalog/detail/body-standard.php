    ...
    <?php if (isset($this->detailProductItem)) : ?>
        ...
        <div class="row">
            <div class="col-6">    
                ...
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        ...
                        <a href="/" style="color:black; font-weight: bold;">Home</a> / <a href="/gallery/<?= $this->currentCategory; ?>" style="color:black; font-weight: bold;"><?= $this->currentCategory; ?></a>
            ...
            <div class="col-6">    
                ...
                <?php if ($this->catProductPos > 1) { ?>
                    <a href="/image/<?= $this->catProductUrls[$this->catProductPos - 2] ?>" style="color:black; font-weight: bold;">&lt; Prev</a>&nbsp;&nbsp;&nbsp;
                ...
                <?php if ($this->catProductPos < $this->catProductCount) { ?>
                    <a href="/image/<?= $this->catProductUrls[$this->catProductPos] ?>" style="color:black; font-weight: bold;">Next &gt;</a>
        ...
        <article class="product row m-0 <?= $this->detailProductItem->getConfigValue('css-class') ?>" data-id="<?= $this->detailProductItem->getId(); ?>">

            <?php

            $previewUrls = json_encode($this->previewUrls);

            ?>

            <image-detail :images='<?php echo $previewUrls; ?>'></image-detail>

            <div class="basket-seperator d-md-none d-lg-none d-xl-none"></div>
            ...
            <div class="col-md-6">
                        ...
                        <?=
                            $this->partial(
                                $this->config(
                                    ...
                                    'common/partials/price-standard'
                                ),
                    ...
                    <form method="POST" action="<?= $enc->attr($this->url($basketTarget, $basketController, $basketAction, ($basketSite ? ['site' => $basketSite] : []), [], $basketConfig)); ?>">
                        ...
                        <?php if ($this->detailProductItem->getType() === 'select') : ?>
                            <div class="catalog-detail-basket-selection">
                                ...
                                <?= $this->partial(
                                    ...
                                    $this->config(
                                        'client/html/common/partials/selection',
                                        'common/partials/selection-standard'
                                    ),
                        ...
                        <div class="catalog-detail-basket-attribute">
                            ...
                            <?= $this->partial(
                                ...
                                $this->config(
                                    'client/html/common/partials/attribute',
                                    'common/partials/attribute-standard'
                                ),
                        ...
                        <div class="stock-list">
                            <?php if ($this->currentCategory == "Prints and Cards") { ?>
                        ...
                        <div class="addbasket">
                            <div class="input-group">
                                ...
                                <?php } else { ?>
                                <input type="hidden" <?= !$this->detailProductItem->isAvailable() ? 'disabled' : '' ?>
                                    name="<?= $enc->attr($this->formparam(['b_prod', 0, 'quantity'])); ?>"
                                    min="<?= $this->detailProductItem->getConfigValue('quantity-step', 1) ?>" max="2147483647"
                                    step="<?= $this->detailProductItem->getConfigValue('quantity-step', 1) ?>" maxlength="10"
                                    required="required" value="1"
                ...
                <?= $this->partial(
                    ...
                    $this->config(
                        'client/html/catalog/partials/actions',
                        'catalog/actions-partial-standard'
                    ),
                    ['productItem' => $this->detailProductItem]
                ); ?>
                ...
                <?= $this->partial(
                    ...
                    $this->config(
                        'client/html/catalog/partials/social',
                        'catalog/social-partial-standard'
                    ),
                    ['productItem' => $this->detailProductItem]
                ); ?>
                ...
                <div class="catalog-detail-additional">
                    ...
                    <?php if (!($textItems = $this->detailProductItem->getRefItems('text', 'long'))->isEmpty()) : ?>
                        <div class="additional-box">
                            <h2 class="additional-shadow"><?= $enc->html($this->translate('client', 'Description'), $enc::TRUST); ?></h2>
                            <div class="container-fluid">
