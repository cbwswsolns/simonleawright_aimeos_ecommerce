...
<!-- CBW: fix anomaly where Aimeos code writes a boolean 1 (True) instead of blank string ('') when the condition $id != $this->get('paymentOption') is True (because of missing first operand in ternary statement).  If left unfixed, when Vue is used, the parser will rasie the following: "Uncaught DOMException: Failed to execute 'setAttribute' on 'Element': '1' is not a valid attribute name."
