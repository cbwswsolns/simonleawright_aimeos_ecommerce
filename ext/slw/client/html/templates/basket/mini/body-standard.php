...
?>
<section class="aimeos basket-mini d-none d-md-block" data-jsonurl="<?= $enc->attr($this->url($jsonTarget, $jsonController, $jsonAction, ($basketSite ? ['site' => $basketSite] : []), [], $jsonConfig)); ?>">
    ...
    <?php if (isset($this->miniBasket)) : ?>
        ...
        <h2><?= $enc->html($this->translate('client', 'Basket'), $enc::TRUST); ?></h2>
...
<a class="btn btn-primary btn-block d-md-none d-lg-none d-xl-none" href="<?= $enc->attr($this->url($basketTarget, $basketController, $basketAction, ($basketSite ? ['site' => $basketSite] : []), [], $basketConfig)); ?>" role="button" aria-pressed="true">BASKET</a>
